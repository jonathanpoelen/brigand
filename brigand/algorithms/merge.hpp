...
namespace brigand
{
  namespace detail
  {
    ...
    : merge_insert<!::brigand::apply<Comp,U,T1>::value, list<R...,T0>, list<T1,Ts...>, list<U,Us...>, Comp>
    {};
    ...
    : merge_insert<!::brigand::apply<Comp,U1,T>::value, list<R...,U0>, list<T,Ts...>, list<U1,Us...>, Comp>
    {};
    ...
    {
      using list = ::brigand::list<U0,U1,U2,U3,U4,U5,U6,U7,U8,U9>;
      using left = ::brigand::list<T0,T1,T2,T3,T4,T5,T6,T7,T8,T9>;
      using right = ::brigand::list<>;
    };
    ...
    : merge_insert<!::brigand::apply<Comp,U0,T0>::value, list<>, list<T0,T1,T2,T3,T4,T5,T6,T7,T8,T9>, list<U0,U1,U2,U3,U4,U5,U6,U7,U8,U9>, Comp>
    {};
    ...
    {
      using list = ::brigand::list<T0,T1,T2,T3,T4,T5,T6,T7,T8,T9>;
      using left = ::brigand::list<>;
      using right = ::brigand::list<U0,U1,U2,U3,U4,U5,U6,U7,U8,U9>;
    };
    ...
    : merge_u9_t0<!::brigand::apply<Comp,T0,U9>::value, list<T0,T1,T2,T3,T4,T5,T6,T7,T8,T9>, list<U0,U1,U2,U3,U4,U5,U6,U7,U8,U9>, Comp>
    {};
    ...
    {
      using sub = merge_t9_u0<!::brigand::apply<Comp,U0,T9>::value, list<T0,T1,T2,T3,T4,T5,T6,T7,T8,T9>, list<U0,U1,U2,U3,U4,U5,U6,U7,U8,U9>, Comp>;
